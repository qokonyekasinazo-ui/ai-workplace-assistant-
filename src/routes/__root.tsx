  ...
  head: () => ({
    meta: [
      ...
      { title: "WorkPilot — AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Draft emails, summarize meetings and plan your week with AI. A lightweight workplace productivity assistant.",
      },
      { property: "og:title", content: "WorkPilot — AI Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "Draft emails, summarize meetings and plan your week with AI.",
      },
